<?php
/**
 * Orthopedic District Page Template
...
<main>
              ...
              <div class="doctor-card bg-white rounded-3xl shadow-lg border border-gray-100 overflow-hidden hover:shadow-2xl transition-all duration-300 group">
                <div class="relative h-80 overflow-hidden">
                  ...
                  <div class="absolute bottom-4 left-4 right-4 translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                    <a href="/doctor-profile.php?id=<?php echo $doctor['id']; ?>" class="w-full bg-white/95 backdrop-blur-sm text-[#328CCB] py-3 rounded-xl font-bold text-center block shadow-lg">View Profile</a>
                  </div>
                </div>
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [{
      ...
      "item": "https://akropolishospital.com/orthopedic-hospital/haryana/<?php echo $district_name; ?>"
    }]
  }
  </script>
